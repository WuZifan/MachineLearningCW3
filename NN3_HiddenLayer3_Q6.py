...
Y3 = tf.sigmoid(tf.matmul(Y2d, W3) + B3)
Y3d=tf.nn.dropout(Y3,pkeep)

Ylogits = tf.nn.softmax(tf.matmul(Y3d, W5) + B5)

# regularization with L2
w1_l2=tf.nn.l2_loss(W1)
w2_l2=tf.nn.l2_loss(W2)
w3_l2=tf.nn.l2_loss(W3)
...
cross_entropy = tf.reduce_mean(cross_entropy+(w1_l2+w2_l2+w3_l2)*beiTa_Daoshu)*100
